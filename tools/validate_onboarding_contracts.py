#!/usr/bin/env python3
"""Validate CalcNova onboarding persistence/source contracts without .NET."""
...
def main() -> int:
    ...
    failures: list[str] = []
    for path in (settings_path, policy_path, view_model_path):
        if not path.is_file():
    ...
    print("Validated versioned onboarding persistence, complete, skip, and normalization contracts.")
    return 0
