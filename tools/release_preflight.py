...
CHECKS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("Exact rational contracts", ("tools/validate_rational_numbers.py", ".")),
    ("Engineering notation contracts", ("tools/validate_engineering_notation.py", ".")),
    ("Bounded export previews", ("tools/validate_export_previews.py", ".")),
    ("Bivariate statistics", ("tools/validate_bivariate_statistics.py", ".")),
    ...
    ("Dynamic controls accessibility", ("tools/validate_dynamic_controls_accessibility.py", ".")),
    ...
    ("Converter preference notice", ("tools/validate_converter_preference_notice.py", ".")),
    ...
    ("Current release completion status", ("tools/validate_completion_status.py", ".")),
    ...
    ("CI workflow hygiene", ("tools/validate_ci_hygiene.py", ".")),
    ("Security automation workflows", ("tools/validate_security_workflows.py", ".")),
    ("NuGet dependency security policy", ("tools/validate_dependency_security.py", ".")),
    ("Source preflight workflow", ("tools/validate_source_preflight_workflow.py", ".")),
    ("Release iOS workflow", ("tools/validate_release_ios_workflow.py", ".")),
    ("Release workflow", ("tools/validate_release_workflow.py", ".")),
    ("Release documentation", ("tools/validate_release_docs.py", ".")),
    ("Artifact integrity infrastructure", ("tools/validate_artifact_integrity.py", ".")),
    ("Release evidence infrastructure", ("tools/validate_release_evidence_infrastructure.py", ".")),
    ("Release-tag validator tests", ("tools/tests/test_validate_release_tag.py",)),
    ("Release identity tests", ("-m", "unittest", "tools.tests.test_release_identity")),
    ...
    ("Source-preflight workflow validator tests", ("-m", "unittest", "tools.tests.test_validate_source_preflight_workflow")),
    ("Release-iOS-workflow validator tests", ("-m", "unittest", "tools.tests.test_validate_release_ios_workflow")),
    ...
    ("Dynamic-controls accessibility validator tests", ("-m", "unittest", "tools.tests.test_validate_dynamic_controls_accessibility")),
    ...
    ("Exact-rational validator tests", ("-m", "unittest", "tools.tests.test_validate_rational_numbers")),
    ("Engineering-notation validator tests", ("-m", "unittest", "tools.tests.test_validate_engineering_notation")),
    ("Export-preview validator tests", ("-m", "unittest", "tools.tests.test_validate_export_previews")),
    ("Bivariate-statistics validator tests", ("-m", "unittest", "tools.tests.test_validate_bivariate_statistics")),
    ...
    ("Converter-notice validator tests", ("-m", "unittest", "tools.tests.test_validate_converter_preference_notice")),
    ...
    ("Completion-status validator tests", ("-m", "unittest", "tools.tests.test_validate_completion_status")),
    ("Platform-workflow validator tests", ("-m", "unittest", "tools.tests.test_validate_platform_workflows")),
    ("Cross-platform source validator tests", ("-m", "unittest", "tools.tests.test_validate_platform_support")),
    ("CI-hygiene validator tests", ("-m", "unittest", "tools.tests.test_validate_ci_hygiene")),
    ...
    ("Release-evidence model tests", ("-m", "unittest", "tools.tests.test_release_evidence")),
    ("Release-evidence runner tests", ("-m", "unittest", "tools.tests.test_run_release_evidence")),
    ("Release-evidence verifier tests", ("-m", "unittest", "tools.tests.test_verify_release_evidence")),
    ("Release-evidence infrastructure validator tests", ("-m", "unittest", "tools.tests.test_validate_release_evidence_infrastructure")),
