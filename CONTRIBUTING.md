...
Thank you for considering a contribution to CalcNova. **CalcNova 2.9.7 is the completed product baseline.** Contributions now focus on maintenance, correctness, security, compatibility, documentation, translations, tests, dependency updates, or explicitly proposed optional enhancements.
...
- `docs/ROADMAP.md` only when optional post-2.9.7 planning is intentionally changed.
